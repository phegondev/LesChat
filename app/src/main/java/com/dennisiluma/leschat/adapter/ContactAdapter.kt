package com.dennisiluma.leschat.adapter
...
import com.dennisiluma.leschat.activity.UserInfoActivity
import com.dennisiluma.leschat.databinding.ContactItemLayoutBinding
import java.util.*
...
class ContactAdapter(private var appContacts: ArrayList<UserModel>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.contactItemLayoutBinding.userModel =
            userModel //using databinding to bind the values to the xml
            ...
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                if (searchContent.isEmpty())
                    ...
                    for (userModel in appContacts) {
                        ...
                        if (userModel.name.lowercase(Locale.ROOT).trim()
